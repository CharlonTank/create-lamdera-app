...
import Evergreen.V1.GoogleOneTap
import Evergreen.V1.I18n
import Evergreen.V1.LocalStorage
import Evergreen.V1.Router
...
type alias FrontendModel =
    ...
    , route : Evergreen.V1.Router.Route
    , chatMessages : List ChatMessage
    , chatInput : String
    , authFlow : Evergreen.V1.Auth.Common.Flow
    , authRedirectBaseUrl : Url.Url
    , loginState : LoginState
    , currentUser : Maybe Evergreen.V1.Auth.Common.UserInfo
...
type alias BackendModel =
    ...
    , lastUpdatedBy : Maybe Effect.Lamdera.ClientId
    , chatMessages : List ChatMessage
    , sessions : SeqDict.SeqDict Effect.Lamdera.SessionId Evergreen.V1.Auth.Common.UserInfo
    , users : SeqDict.SeqDict Email User
    , pendingAuths : SeqDict.SeqDict Effect.Lamdera.SessionId Evergreen.V1.Auth.Common.PendingAuth
...
type BasicFrontendMsg
    ...
    | GoogleOneTapStatusReceived Evergreen.V1.GoogleOneTap.OneTapStatus
...
type BasicToBackend
    ...
    | GetCounterToBackend
    | AuthToBackendToBackend Evergreen.V1.Auth.Common.ToBackend
    | MockAuthLoginToBackend String String
    | MockAuthRegisterToBackend String String String String
...
type BasicToFrontend
    ...
    | AuthToFrontendToFrontend Evergreen.V1.Auth.Common.ToFrontend
    | AuthSuccessToFrontend Evergreen.V1.Auth.Common.UserInfo
