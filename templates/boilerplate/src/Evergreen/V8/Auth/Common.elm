module Evergreen.V8.Auth.Common exposing (..)

import Effect.Lamdera
import Effect.Time
import Evergreen.V8.OAuth
import Evergreen.V8.OAuth.AuthorizationCode
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V8.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V8.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V8.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V8.OAuth.Token
    , created : Effect.Time.Posix
